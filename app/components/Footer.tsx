      ...
      <div className="max-w-4xl mx-auto px-6">
        <div className="flex flex-col items-center gap-8">
          <div className="text-center">
            <Link
              href="/"
              className="text-2xl font-bold tracking-wider mb-1 inline-block transition-opacity hover:opacity-70"
          ...
          <nav className="flex items-center gap-6">
            {[
              ...
              <Link
                key={item.href}
                href={item.href}
                className="text-sm tracking-widest opacity-40 transition-opacity hover:opacity-70"
                style={{ fontFamily: "var(--font-kaisei)", color: "#F0EBE0" }}
              >
                {item.label}
              </Link>
